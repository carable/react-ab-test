...
if (process.env.NODE_ENV === "production" || !_ExecutionEnvironment.canUseDOM) {
  ...
  var Debugger = function (_Component) {
    ...
    function Debugger(props) {
      ...
      var _this = _possibleConstructorReturn(this, (Debugger.__proto__ || Object.getPrototypeOf(Debugger)).call(this, props));
    ...
    _createClass(Debugger, [{
      ...
      value: function updateExperiments() {
        this.setState({
          experiments: _emitter2.default.getActiveExperiments()
        });
      }
      ...
      value: function render() {
        ...
        if (this.state.visible) {
          ...
          return _react2.default.createElement(
            'div',
            { className: 'pushtell-container pushtell-handle', onClick: this.toggleVisibility.bind(this) },
  ...
  Debugger.displayName = "Pushtell.Debugger";
  ;
